...
QT_MOC_LITERAL(1, 9, 15), // "slotZoomChanged"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 5), // "value"
QT_MOC_LITERAL(4, 32, 19) // "slotRotationChanged"

    },
    "PageView\0slotZoomChanged\0\0value\0"
    "slotRotationChanged"
};
...
void PageView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->slotZoomChanged((*reinterpret_cast< qreal(*)>(_a[1]))); break;
        case 1: _t->slotRotationChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
